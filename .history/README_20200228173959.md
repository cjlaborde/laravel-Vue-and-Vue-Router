...
>These controllers can resolve and render themselves on the fly

1, go to import LoadersAndAnimations from './components/LoadersAndAnimations'
2. register it as an async controller instead
3. let LoadersAndAnimations = () => import('./components/LoadersAndAnimations');
4. 